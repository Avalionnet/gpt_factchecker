                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                           href="https://www.creative-tim.com/learning-lab/bootstrap-vue/colors/argon-dashboard">
                            <i class="ni ni-palette"></i> NUS Center for Trusted Internet and Community
                        </a>
                    </li>
                </ul>
            </div>
  ...
  export default {
    ...
    props: {
      logo: {
        ...
        description: 'FactCheck Logo'
      },
      autoClose: {
        type: Boolean,
        default: true,
        description: 'Determines if sidebar should autoclose when clicking an item for mobile'
      }
    },
    provide() {
      return {
